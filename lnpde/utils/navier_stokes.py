...
def create_argparser() -> argparse.ArgumentParser:
    ...
    # Data.
    parser.add_argument("--data_folder", type=str, default="./experiments/data/datasets/navier_stokes/partial/", help="Path to the dataset.")
    ...
    parser.add_argument("--delta_inf", type=float, default=0.20, help="Fraction of obsevations used for z0 inference at test time.")

    parser.add_argument("--model_folder", type=str, default="./models/navier_stokes/", help="Folder for saving/loading models.")
